...
export default function Invoicetable({ invoices: initialInvoices = [], isLoading = false }) {
  const columns = [
    ...
    { key: 'client', label: 'MÜŞTERİ', icon: <ClientIcon />, sortable: true },
    { key: 'billed', label: 'TUTAR', icon: <AmountIcon />, sortable: true,
  ...
  const editFormFields = [
    ...
    { name: 'billed', label: 'Tutar', type: 'number', parseValue: (value) => parseFloat(value) },
  ...
  return (
    <DataTable
      ...
      editFormTitle="Fatura Kaydı Düzenle"
      emptyMessage="Henüz Fatura Kaydı Yok"
      emptySubMessage="Lütfen fatura girişi eklemek için yeni bir kayıt oluşturun."
      luxuryMode={true}
    />
  );
}
