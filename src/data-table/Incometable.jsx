...
// Icon components with enhanced luxury styling
const DateIcon = () => (
...
export default function Incometable({ products: initialProducts = [], isLoading = false }) {
  // Enhanced income type mapping with luxury classifications
  const incomeTypeMap = {
  ...
  const columns = [
    ...
    { 
      ...
      render: (item) => {
        ...
        return (
          <span className={`type-badge ${type.class} premium-badge`}>
            {type.label}
          </span>
        );
      }
    ...
    { 
      ...
      sortable: false,
      render: (item) => {
        // Enhanced status display with premium styling
